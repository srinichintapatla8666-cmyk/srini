...
SECRET_KEY = 'django-insecure-tgfya6-90-#s3b=i2u1f7!f#yf-its1@i=9_nba(y$c+g543#*'
...
MIDDLEWARE = [
    ...
    'myapp.middleware.TimeRequestMiddleware',
...
# PostgreSQL configuration (disabled - to enable, see POSTGRESQL_SETUP.md)
# DATABASES = {
#     "default": {
